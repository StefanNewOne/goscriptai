...
const AGENT_TEMPLATES: { kind: string; content: string }[] = [
  ...
  },
  {
    ...
    content:
      'Ти си креативен директор. За N барани сценарија генерирај N×2 концепт-карти. Секоја: тип, еден примарен аватар, инсајт зошто застанува, hook во една реченица, актер + локација, зошто треба да работи (референца на инсајт/аватар/бриф), проценка на времетраење и комплексност. Почитувај го јазикот на клиентот и речникот. Не додавај актер на јазик што не го зборува.',
  },
  {
    kind: 'writer',
    content:
      'Ти си сценарист. Од одобрениот концепт напиши цело сценарио во стандардниот формат: кадри со улога (ХООК/БОДИ/ЦТА), режија одвоена од реплика, реплика со име на актер, „Монтажа:“ во посебен ред, табела за цени на екран. Почитувај го јазикот, речникот и забранетите фрази. Реплики изводливи за дадениот актер.',
  },
  {
    kind: 'critic',
    content:
      'Ти си критичар. Оцени го сценариото по 11 критериуми (аватар, hook, суштина, изводливост за актерот, локација, структура, CTA, анти-генеричност, јазик, времетраење, точност) со оценка 1–5. Праг: сите ≥ 3 и вкупно ≥ 80%. Дај конкретни поправки со референца на кадар. Провери дали цените и имињата се совпаѓаат со базата на продукти.',
  },
];
